...
namespace ProjectManagementSystem.Migrations
{
    ...
    [Migration("20250418051315_zxcworld2")]
    partial class zxcworld2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagementSystem.Models.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectManagementSystem.Models.TaskAssignee", b =>
                {
                    b.Property<int>("ProjectTaskId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectManagementSystem.Models.Attachment", b =>
                {
                    b.HasOne("ProjectManagementSystem.Models.ProjectTask", "ProjectTask")
                        .WithMany("Attachments")
                        .HasForeignKey("ProjectTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectManagementSystem.Models.User", "UploadedBy")
                        .WithMany()
